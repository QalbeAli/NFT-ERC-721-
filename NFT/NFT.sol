...
contract ApniNFT is ERC721Enumerable, Ownable {
    uint256 public mintPrice = 0.08 ether;

    uint256 private reserveAtATime = 35;

    address private Address1 = 0x50B4625f897A9BFFDDfd2A95Eaa1E235A88f4749;
    address private Address2 = 0xde9c4Cf1c166CF2eaeDfa4ac65830aDf7b5feaE4;
    ...
    constructor(string memory baseURI) ERC721("Apni NFT", "APNF") {
        setBaseURI(baseURI);
    }
    ...
    function setMaximumAllowedTokensPerWallet(uint256 _count)
        public
        onlyAuthorized
    {
    ...
    function reserveToCustomWallet(address _walletAddress, uint256 _count)
        public
        onlyAuthorized
    {
    ...
    function mint(address _to, uint256 _count) public payable saleIsOpen {
        ...
        if (_to != owner()) {
            require(
                balanceOf(_to) + _count <= maximumAllowedTokensPerWallet,
